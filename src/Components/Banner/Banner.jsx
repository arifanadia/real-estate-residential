...
const Banner = () => {
    return (
        <div className=' mb-20'>
            ...
            >
                <SwiperSlide>
                    <div className="h-[600px] bg-no-repeat bg-cover bg-center  pt-20   " style={{ backgroundImage: `linear-gradient(#211f2fCC, #918ca926 ), url(${bg1})` }} >
                        <h1 className='text-6xl text-white -tracking-tight leading-snug font-semibold '>Find Your <br /> <span className='font-bold text-skyBlue'>Dream</span> Home !</h1>
            ...
            <div className='md:max-w-6xl mx-auto bg-white p-8  rounded-lg absolute -bottom-5 shadow-xl left-[20%] z-10 '>
                <form  >
                    <input className='md:w-[330px] border border-skyBlue h-16 p-4 rounded-l-lg' type="text" placeholder='Search properties by title ' name="" id="" />
                    <select className='w-[210px]  border-skyBlue border-y h-16 p-4'>
                        <option>Select your status</option>
                        <option>Rent</option>
                        <option>Sale</option>
                    </select>
                    <select className='w-[210px] border-skyBlue border h-16 p-4'>
                    ...
                    <button className='h-16 py-3.5 px-4 text-white bg-skyBlue text-lg rounded-r-lg'>Search</button>
                </form>
            </div>
